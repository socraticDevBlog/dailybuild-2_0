(function ($) {
  ...
  // change displayed properties and callback url depending on active page
  if ($("#index").length === 1) {
    $(".nav-link").removeClass("active");
    $("#index-link").addClass("active");
    $("#about-link").attr("index.html#aboutSection");
  } else if ($("#chat").length === 1) {
    $(".nav-link").removeClass("active");
    $("#chat-link").addClass("active");
    $("#about-link").attr("href", "chat.html#aboutSection");
  } else if ($("#tekdude").length === 1) {
    $(".nav-link").removeClass("active");
